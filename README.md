# Portfolio: Intelligent Systems & Socio-Technical Governance
...
Projects 3 and 5 emphasize the Human-in-the-Loop. Whether addressing investigator workload through structured task automation and capacity planning, or analyzing how education influences economic mobility, these projects prioritize the human consequences of technical systems.



3. Evidence-Based Interpretability

Projects 2 and 5 focus on making complex datasets legible to non-expert stakeholders. By building interpretability layers for financial markets and census data, the work promotes democratic access to information and informed decision-making.
...
|---------|--------------|
| **Languages** | Python (Pandas, NumPy, Matplotlib)<br>SQL (Complex Querying, Aggregation, Performance Analysis) |
| **Methodologies** | Forensic Sequence Auditing<br>Heuristic Valuation<br>Resource and Capacity Forecasting<br>Socio-Economic Pattern Recognition |
| **Tools** | Jupyter Notebooks<br>GitHub-ready Documentation<br>Excel-based Dashboards and Reporting |
...
This project involves a comprehensive analysis of Requests for Information (RFIs) from global partner banks to identify systemic vulnerabilities in digital payment flows. By auditing 100 high-priority cases, key risk clusters emerge where sanctions and AML concerns intersect with institutional behaviour.
...
This portfolio demonstrates that I approach technology not only as a technical practitioner, but as a socio-technical systems thinker. I apply data analysis to real-world systems while maintaining a strong ethical and sustainability lens, ensuring that intelligent systems contribute to equitable, transparent, and resilient societies.
